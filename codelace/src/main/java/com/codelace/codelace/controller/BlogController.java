...
public class BlogController {
	...
	// Method to get all blogs by project
	@GetMapping("/projects/{id}")
	public ResponseEntity<List<BlogResponseDTO>> getAllBlogsByProject(@PathVariable Long id) {
		List<BlogResponseDTO> blogs = blogService.getAllByProject(id);
		return new ResponseEntity<>(blogs, HttpStatus.OK);
	}
