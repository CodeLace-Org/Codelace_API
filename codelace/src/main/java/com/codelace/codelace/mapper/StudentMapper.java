...
public class StudentMapper {
    ...
    public Student convertStudentUpdatePasswordToEntity(StudentUpdatePasswordRequestDTO studentUpdatePasswordRequestDTO){
        return modelMapper.map(studentUpdatePasswordRequestDTO, Student.class);
    }
