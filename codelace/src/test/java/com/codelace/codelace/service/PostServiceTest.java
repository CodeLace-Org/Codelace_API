...
public class PostServiceTest {
	...
	public void testCreatePost_Successful() {
		...
		String base64Image = "";
		postRequestDTO.setImage(Base64.getDecoder().decode(base64Image));
	...
	@Test 
	public void testGetPostsByProjectId_ExistingId(){
		// Arrange
		Long id = 1L;
	...
	public void testGetPostsByStudent_Successful() {
		...
		// Act
		List<PostByStudentResponseDTO> result = postService.getPostsByStudent(studentId);
	...
	public void testGetPostsByStudent_StudentNotFound() {
		...
		// Act & Assert
		assertThrows(ResourceNotFoundException.class, () -> postService.getPostsByStudent(studentId));
	}
